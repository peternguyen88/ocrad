console.log('ICO Transaction v36 - Auto 2.6 - Mapped Captcha');
...
var ICOTransaction = function () {
    ...
    this.init = function (data, userWallet) {
        ...
        if(!self.ICO().BuyICO && data.Limit < COIN_LIMIT){     // Reload to get 200 limit
    ...
    this.OpenBuyICO = function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                //$('div.modal-header').append($('b.uch--value--color').clone());
				...
				if($('.img-robot-captcha').length){		                                //// ----  If there is robot captcha then submit it to Anti-captcha
                    ...
                    setTimeout(function(){$('#div-buy-uch').modal('hide');self.OpenBuyICO();}, 1000);
                }
            ...
            success: function (data) {
                if (data.Result == "OK") {
                    if (data.Data.IsSuccess) {
                        ...
                        setTimeout(function(){self.OpenBuyICO();}, 1500);      // Reload the Popup and buy again
                        ...
                        bootbox.dialog({
                            ...
                            buttons: {
                                confirm: {
                                    ...
                                    className: "btn-warning button-bootbox-close",
                                    callback: function () {
                                        // window.location.reload();                        //// ---- Don't reload window - trying buying again instead
                                    }
                                }
                            }
                        });
                        //setTimeout(function () { window.location.reload(); }, 2000);      //// ---- Don't reload window - trying buying again instead
                    }
                    else {
    ...
    this.HandleSubmissionError = function (message){                                        //// ---- If ICO not started - retry. If captcha invalid - reload captcha
        ...
        if(message === 'The UCH ICO hasn’t started yet'){
            ...
            setTimeout(function(){self.Buy();}, 3000);
        }
        if(message.trim() === 'The maximum amount of UCH that you can buy: 0'){
            setTimeout(function(){self.Buy();}, 1000)
        }
        if(message && message.toLowerCase().indexOf('timeout') !== -1){
            window.location.reload();
        }
    ...
    this.resolveMappedCaptcha = function(imgSrc){
        ...
        if(imgSrc.indexOf('uch-captcha-') > 0){
            else if(imgSrc.indexOf('/uch-captcha-150.png') !== -1) mappedCaptcha = '2u9zh';
            else if(imgSrc.indexOf('/uch-captcha-151.png') !== -1) mappedCaptcha = '0bn9z';
            else if(imgSrc.indexOf('/uch-captcha-152.png') !== -1) mappedCaptcha = 'z3u8v';
            else if(imgSrc.indexOf('/uch-captcha-153.png') !== -1) mappedCaptcha = '82v71';
            else if(imgSrc.indexOf('/uch-captcha-154.png') !== -1) mappedCaptcha = 'z36ec';
            else if(imgSrc.indexOf('/uch-captcha-155.png') !== -1) mappedCaptcha = 'apu71';
            else if(imgSrc.indexOf('/uch-captcha-156.png') !== -1) mappedCaptcha = 'cfkke';
            else if(imgSrc.indexOf('/uch-captcha-157.png') !== -1) mappedCaptcha = 'fzt1b';
            else if(imgSrc.indexOf('/uch-captcha-158.png') !== -1) mappedCaptcha = 'vpfrh';
            else if(imgSrc.indexOf('/uch-captcha-159.png') !== -1) mappedCaptcha = '3t6zj';
            
            
            else if(imgSrc.indexOf('/uch-captcha-160.png') !== -1) mappedCaptcha = '7nhaq';
            else if(imgSrc.indexOf('/uch-captcha-161.png') !== -1) mappedCaptcha = 'gvtqe';
            else if(imgSrc.indexOf('/uch-captcha-162.png') !== -1) mappedCaptcha = '2xd9a';
            else if(imgSrc.indexOf('/uch-captcha-163.png') !== -1) mappedCaptcha = 'h8pu1';
            else if(imgSrc.indexOf('/uch-captcha-164.png') !== -1) mappedCaptcha = '9krej';
            else if(imgSrc.indexOf('/uch-captcha-165.png') !== -1) mappedCaptcha = 'bh3jt';
            else if(imgSrc.indexOf('/uch-captcha-166.png') !== -1) mappedCaptcha = 'c27qq';
            else if(imgSrc.indexOf('/uch-captcha-167.png') !== -1) mappedCaptcha = 'd7ykq';
            else if(imgSrc.indexOf('/uch-captcha-168.png') !== -1) mappedCaptcha = '4q193';
            else if(imgSrc.indexOf('/uch-captcha-169.png') !== -1) mappedCaptcha = 'yprp7';
            
            
                 if(imgSrc.indexOf('/uch-captcha-1.png') !== -1) mappedCaptcha = 'f7gkb';
            ...
            else if(imgSrc.indexOf('/uch-captcha-50.png') !== -1) mappedCaptcha = 'rrhnu';
            else if(imgSrc.indexOf('/uch-captcha-51.png') !== -1) mappedCaptcha = 'bjd7b';
            else if(imgSrc.indexOf('/uch-captcha-52.png') !== -1) mappedCaptcha = '2k9pp';
            else if(imgSrc.indexOf('/uch-captcha-53.png') !== -1) mappedCaptcha = '9uglk';
            else if(imgSrc.indexOf('/uch-captcha-54.png') !== -1) mappedCaptcha = 'qrrvj';
            else if(imgSrc.indexOf('/uch-captcha-55.png') !== -1) mappedCaptcha = 'kv8bf';
            else if(imgSrc.indexOf('/uch-captcha-56.png') !== -1) mappedCaptcha = '7j7k8';
            else if(imgSrc.indexOf('/uch-captcha-57.png') !== -1) mappedCaptcha = 'yrfvd';
            else if(imgSrc.indexOf('/uch-captcha-58.png') !== -1) mappedCaptcha = '2ujly';
            else if(imgSrc.indexOf('/uch-captcha-59.png') !== -1) mappedCaptcha = 'cauq3';
            
            else if(imgSrc.indexOf('/uch-captcha-60.png') !== -1) mappedCaptcha = '7ffxr';
            else if(imgSrc.indexOf('/uch-captcha-61.png') !== -1) mappedCaptcha = 'y26gx';
            else if(imgSrc.indexOf('/uch-captcha-62.png') !== -1) mappedCaptcha = '2nbvb';
            else if(imgSrc.indexOf('/uch-captcha-63.png') !== -1) mappedCaptcha = 'qxejc';
            else if(imgSrc.indexOf('/uch-captcha-64.png') !== -1) mappedCaptcha = '7nbq9';
            else if(imgSrc.indexOf('/uch-captcha-65.png') !== -1) mappedCaptcha = 'zt666';
            else if(imgSrc.indexOf('/uch-captcha-66.png') !== -1) mappedCaptcha = 'dzh1a';
            else if(imgSrc.indexOf('/uch-captcha-67.png') !== -1) mappedCaptcha = 'v2rnk';
            else if(imgSrc.indexOf('/uch-captcha-68.png') !== -1) mappedCaptcha = 'thhx6';
            else if(imgSrc.indexOf('/uch-captcha-69.png') !== -1) mappedCaptcha = 'okedg';
            
        }
        else if(imgSrc.indexOf('/10.png') !== -1) mappedCaptcha = 'g3fer';
        else if(imgSrc.indexOf('/11.png') !== -1) mappedCaptcha = 'e3chn';
        else if(imgSrc.indexOf('/12.png') !== -1) mappedCaptcha = 'p6vx4';
        else if(imgSrc.indexOf('/13.png') !== -1) mappedCaptcha = 'jg3y3';
        else if(imgSrc.indexOf('/14.png') !== -1) mappedCaptcha = 'bxy2g';
        else if(imgSrc.indexOf('/15.png') !== -1) mappedCaptcha = 'ujkah';
        else if(imgSrc.indexOf('/16.png') !== -1) mappedCaptcha = 'qn4ex';
        else if(imgSrc.indexOf('/17.png') !== -1) mappedCaptcha = '2841y';
        else if(imgSrc.indexOf('/18.png') !== -1) mappedCaptcha = 'uk2d9';
        else if(imgSrc.indexOf('/19.png') !== -1) mappedCaptcha = 'q364u';
        else if(imgSrc.indexOf('/20.png') !== -1) mappedCaptcha = 'bhqaq';
        else if(imgSrc.indexOf('/1.png') !== -1) mappedCaptcha = '83nuk';
        else if(imgSrc.indexOf('/2.png') !== -1) mappedCaptcha = 'czn1v';
        else if(imgSrc.indexOf('/3.png') !== -1) mappedCaptcha = '9tngv';
        else if(imgSrc.indexOf('/4.png') !== -1) mappedCaptcha = 'nkgfx';
        else if(imgSrc.indexOf('/5.png') !== -1) mappedCaptcha = 'fuqjb';
        else if(imgSrc.indexOf('/6.png') !== -1) mappedCaptcha = 'xx7nr';
        else if(imgSrc.indexOf('/7.png') !== -1) mappedCaptcha = '9tpvn';
        else if(imgSrc.indexOf('/8.png') !== -1) mappedCaptcha = '4zjg3';
        else if(imgSrc.indexOf('/9.png') !== -1) mappedCaptcha = 'errzh';
        ...
        if(mappedCaptcha){
            ...
            if(self.ICO().BuyICO){	// Submit immediately if ICO Started
				setTimeout(function() {self.Buy();}, 2500);
			}
        }
    }
	...
	this.appendCotrolElements = function() {
	    ...
	    $('#btn-stop-buy').click(function(){stopOperation = !stopOperation; $('#btn-stop-buy').text(stopOperation ? 'Resume' : 'Stop'); console.log('stopOperation = '+stopOperation);});
