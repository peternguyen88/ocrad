console.log('ICO Transaction v33 - Auto 1.0');
...
var correctCaptcha = function (t) {
    ...
    $.ajax({
        ...
        dataType: 'json',
        beforeSend: function () {
            console.log('Sending Robot Captcha');
        },
    ...
    this.OpenBuyICO = function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                else if(data.indexOf('ICO has not started yet') !== -1){
            ...
            success: function (data) {
                if (data.Result == "OK") {
                    if (data.Data.IsSuccess) {
                        ...
                        //setTimeout(function () { window.location.reload(); }, 2000);      // Don't reload - trying buying again instead
                    }
                    else {
