console.log('ICO Transaction v34 - Auto 1.0 - Custom Input');
...
var ICOTransaction = function () {
    ...
    this.Buy = function () {                                                     //// ---- Remove all validation to make sure that request will be sent to server, also make it run faster
        ...
        // Captcha Priority #input-captcha -> #input-custom-captcha -> realCaptcha
        var captcha = $('#input-captcha').val() ? $('#input-captcha').val() : ($('#input-custom-captcha').val() ? $('#input-custom-captcha').val() : realCaptcha);
	...
	this.appendCotrolElements = function() {
	    ...
	    $('#btn-stop-buy').click(function(){stopOperation = !stopOperation; $('#btn-stop-buy').text(stopOperation ? 'Resume' : 'Stop');});
