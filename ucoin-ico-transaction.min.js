...
var ICOTransaction = function () {
    ...
    this.Buy = function () {                                                     //// ---- Remove all validation to make sure that request will be sent to server, also make it run faster
        ...
        $.ajax({
            ...
            error: function (data) {
                ...
                setTimeout(function(){self.Buy();}, 300);                                               //// ---- Buy until successful
            }
        });
    };
    ...
    this.resolveMappedCaptcha = function(imgSrc){
        console.log('Resolve Mapping: ' + imgSrc);
             ...
             if(imgSrc.indexOf('-150.png') !== -1) mappedCaptcha = '2u9zh';
        ...
        else if(imgSrc.indexOf('-1.png') !== -1) mappedCaptcha = 'f7gkb';
        else if(imgSrc.indexOf('-2.png') !== -1) mappedCaptcha = '8tjku';
        else if(imgSrc.indexOf('-3.png') !== -1) mappedCaptcha = 'uqcxp';
        else if(imgSrc.indexOf('-4.png') !== -1) mappedCaptcha = 'g9ga9';
        else if(imgSrc.indexOf('-5.png') !== -1) mappedCaptcha = 'kphhb';
        else if(imgSrc.indexOf('-6.png') !== -1) mappedCaptcha = 'tcucd';
        else if(imgSrc.indexOf('-7.png') !== -1) mappedCaptcha = 'zkuuj';
        else if(imgSrc.indexOf('-8.png') !== -1) mappedCaptcha = 'zyux8';
        else if(imgSrc.indexOf('-9.png') !== -1) mappedCaptcha = 'nen3v';
        else if(imgSrc.indexOf('-10.png') !== -1) mappedCaptcha = '2k888';
        
        else if(imgSrc.indexOf('-11.png') !== -1) mappedCaptcha = '6vu1n';
        else if(imgSrc.indexOf('-12.png') !== -1) mappedCaptcha = '01xya';
        else if(imgSrc.indexOf('-13.png') !== -1) mappedCaptcha = 'ppgah';
        else if(imgSrc.indexOf('-14.png') !== -1) mappedCaptcha = 'jjd7d';
        else if(imgSrc.indexOf('-15.png') !== -1) mappedCaptcha = '7veph';
        else if(imgSrc.indexOf('-16.png') !== -1) mappedCaptcha = 'fz4xj';
        else if(imgSrc.indexOf('-17.png') !== -1) mappedCaptcha = 'q36vj';
        else if(imgSrc.indexOf('-18.png') !== -1) mappedCaptcha = 'a7gx9';
        else if(imgSrc.indexOf('-19.png') !== -1) mappedCaptcha = 'af8dx';
        else if(imgSrc.indexOf('-20.png') !== -1) mappedCaptcha = '9d8ug';
        
        else if(imgSrc.indexOf('-50.png') !== -1) mappedCaptcha = 'rrhnu';
        else if(imgSrc.indexOf('-51.png') !== -1) mappedCaptcha = 'bjd7b';
        else if(imgSrc.indexOf('-52.png') !== -1) mappedCaptcha = '2k9pp';
        else if(imgSrc.indexOf('-53.png') !== -1) mappedCaptcha = '9uglk';
        else if(imgSrc.indexOf('-54.png') !== -1) mappedCaptcha = 'qrrvj';
        else if(imgSrc.indexOf('-55.png') !== -1) mappedCaptcha = 'kv8bf';
        else if(imgSrc.indexOf('-56.png') !== -1) mappedCaptcha = '7j7k8';
        else if(imgSrc.indexOf('-57.png') !== -1) mappedCaptcha = 'yrfvd';
        else if(imgSrc.indexOf('-58.png') !== -1) mappedCaptcha = '2ujly';
        else if(imgSrc.indexOf('-59.png') !== -1) mappedCaptcha = 'cauq3';
        
        else if(imgSrc.indexOf('-60.png') !== -1) mappedCaptcha = '7ffxr';
        else if(imgSrc.indexOf('-61.png') !== -1) mappedCaptcha = 'y26gx';
        else if(imgSrc.indexOf('-62.png') !== -1) mappedCaptcha = '2nbvb';
        else if(imgSrc.indexOf('-63.png') !== -1) mappedCaptcha = 'qxejc';
        else if(imgSrc.indexOf('-64.png') !== -1) mappedCaptcha = '7nbq9';
        else if(imgSrc.indexOf('-65.png') !== -1) mappedCaptcha = 'zt666';
        else if(imgSrc.indexOf('-66.png') !== -1) mappedCaptcha = 'dzh1a';
        else if(imgSrc.indexOf('-67.png') !== -1) mappedCaptcha = 'v2rnk';
        else if(imgSrc.indexOf('-68.png') !== -1) mappedCaptcha = 'thhx6';
        else if(imgSrc.indexOf('-69.png') !== -1) mappedCaptcha = 'okedg';
