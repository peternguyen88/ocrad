console.log('ICO Transaction v36 - Auto 2.7 - Mapped Captcha');
    ...
    this.resolveMappedCaptcha = function(imgSrc){
        ...
        if(mappedCaptcha){
            ...
            if(self.ICO().BuyICO){	// Submit immediately if ICO Started
                var delayTime = 1500 + Math.floor(Math.random() * 2000);    // Between 1.5s & 4.5s
                console.log('Delay Time: ' + delayTime);
				setTimeout(function() {self.Buy();}, delayTime);
			}
        }
    }
