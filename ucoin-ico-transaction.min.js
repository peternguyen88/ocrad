...
$('#div-buy-uch').on('shown.bs.modal', function () {
	correctCaptcha();
});
...
var addBuyNowButton = function(){	
	var buyDiv = $('<div>');
	buyDiv.append($('<h4 class="buy-ico-title-time"><img src="/Content/images/time-buy-ico.png" />ICO STARTS NOW: </h4>'));
	buyDiv.append($('<div class="ico-action text-center enabled">'));
	buyDiv.append($('<button class="btn btn-warning enabled" id="buy--ico--now">BUY UCH</button>'));
	
	$('#div-time-count-down').before(buyDiv);
}
